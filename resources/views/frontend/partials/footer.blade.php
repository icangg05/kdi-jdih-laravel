					...
					<ul class="list-style-1 no-margin">
						<li>
							<span class="d-inline-block vertical-align-top font-size18"><i
									class="ti-location-pin text-theme-color"></i></span>
							<span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-10px-left">Perpustakaan
								Kota Kendari</span>
							<span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-35px-left">Jl. Drs. H.
								Abd. Silondae No. 8 , Kel. Mandonga Kec. Mandonga 93111</span>
						</li>
						<li>
							<span class="d-inline-block vertical-align-top font-size18"><i
									class="ti-mobile text-theme-color"></i></span>
							<span class="d-inline-block width-65 sm-width-85 vertical-align-top padding-10px-left">082187948080</span>
						</li>
						<li>
							<span class="d-inline-block vertical-align-top font-size18"><i
									class="ti-email text-theme-color"></i></span>
							<span
								class="d-inline-block width-65 sm-width-85 vertical-align-top padding-10px-left">kurniawan.ilyas@kendarikota.go.id</span>
						</li>
					</ul>
				</div>
				...
				<ul class="social-icon-style no-margin">
					<li>
						<a target="_blank" class="text-white"
							href="https://www.facebook.com/profile.php?id=100083031531002&locale=id_ID"><i
								class="fab fa-facebook-f"></i></a> Kendarikota
					</li>
					<li>
						<a target="_blank" class="text-white" href="https://www.youtube.com/@kendarikotagoid9481"><i
								class="fab fa-youtube"></i></a>
						Kendarikota go id
					</li>
					<li>
						<a target="_blank" class="text-white" href="https://www.instagram.com/kendarikota/"><i
