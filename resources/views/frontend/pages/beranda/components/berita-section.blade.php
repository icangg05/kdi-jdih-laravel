<section class="news" style="background: #E5E5E5 ;">
  <div class="container">
      ...
      @foreach ($berita as $item)
        <div class="col-lg-4 sm-margin-30px-bottom">
          <div class="card h-100">
            <a href="http://jdih.kendarikota.go.id/berita/view/56">
              <img src="{{ asset('assets/frontend/img/default.jpg') }}" alt="img" class="card-img-top rounded">
            </a>
    ...
    <div class="float-right mt-4 link">
      <a class="btn btn-primary" href="/berita/index"><i class="fa-regular fa-newspaper"></i> &nbsp; Berita
        Lainnya</a>
    </div>
  </div>
</section>
