  ...
  <div class="box-body no-padding">
    <form class="form-horizontal" action="{{ $route }}" method="post">
      ...
      <div class="box box-primary box-solid">
        ...
        <div class="box-body">
          {{-- Status --}}
          <x-backend.input-select label="Status" key="status_perter" placeholder="--Pilih status--" :value="$peraturanTerkait->status_perter ?? ''" required
            :data="$dataStatus" />

          {{-- Peraturan terkait --}}
          <x-backend.input-select label="Peraturan Terkait" key="peraturan_terkait" :value="$peraturanTerkait->peraturan_terkait ?? ''"
            placeholder="--Pilih peraturan--" required :data="$dataPeraturan" />

          {{-- Catatan --}}
          <x-backend.input-text label="Catatan" key="catatan_perter" :value="$peraturanTerkait->catatan_perter ?? ''"
