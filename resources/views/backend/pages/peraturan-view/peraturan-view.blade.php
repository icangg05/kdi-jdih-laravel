<x-layouts.backend :title="$title" :listNav="[['label' => 'Peraturan', 'route' => 'backend.peraturan.index'], ['label' => $title]]">
  <div class="nav-tabs-custom">
    <ul class="nav nav-tabs dashboard_tabs_cl">
      ...
      <li @class(['active' => session('tabActive') == 'dataDokumenTerkait'])>
        <a href="#tab_6" data-toggle="tab">Dokumen Terkait</a>
      </li>
    ...
    <div class="tab-content">
      ...
      <div @class([
        ...
        <div class="box-header">
          <a class="btn btn-success btn-flat" href="/backend/peraturan/tambah-hasil-uji-materi?id=554"><i
              class="fa fa-plus-circle"></i> Tambah Uji Materi</a>
          <p></p>
          <div id="w17" class="grid-view is-bs3 hide-resize" data-krajee-grid="kvGridInit_a9d0bb4b"
            data-krajee-ps="ps_w17_container">
            <div id="w17-container" class="table-responsive kv-grid-container">
              <table class="kv-grid-table table table-bordered table-striped kv-table-wrap">
                <thead>
                  ...
                  <tr>
                    <th class="text-center">No</th>
                    <th data-col-seq="1">Hasil Uji Materi</th>
                    <th data-col-seq="2">Status</th>
                    <th data-col-seq="3">Catatan</th>
                    <th class="text-center" style="width: 150px;">Aksi</th>
                  </tr>
      ...
      <div @class(['tab-pane', 'active' => session('tabActive') == 'dataStatus']) id="tab_8">
        ...
        <div class="box-header">
          <a class="btn btn-success btn-flat" href="/backend/peraturan/tambah-status?id=554"><i
              class="fa fa-plus-circle"></i> Tambah Status</a>
          <p></p>
          <div id="w21" class="grid-view is-bs3 hide-resize" data-krajee-grid="kvGridInit_fab56620"
            data-krajee-ps="ps_w21_container">
            <div id="w21-container" class="table-responsive kv-grid-container">
              <table class="kv-grid-table table table-bordered table-striped kv-table-wrap">
                <thead>
                  ...
                  <tr>
                    <th class="text-center">No</th>
                    <th data-col-seq="1">Status</th>
                    <th data-col-seq="2">Peraturan</th>
                    <th data-col-seq="3">catatan</th>
                    <th data-col-seq="4">Tanggal Perubahan</th>
                    <th class="text-center" style="width: 150px;">Aksi</th>
                  </tr>
